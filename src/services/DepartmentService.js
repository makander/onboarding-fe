...
const findAllDepartmentTasks = async (id) => axios.get(`${process.env.REACT_APP_BASE_URL}/api/department/${id}/tasks`).then((res) => res.data);

const findAllDepartmentLists = async (id) => axios.get(`${process.env.REACT_APP_BASE_URL}/api/department/${id}/list`).then((res) => res.data);
